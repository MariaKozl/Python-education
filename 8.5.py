class Storehouse:
    ...
    def To_add_device(self):
        ...
        device_price = input('Введите цену нового устройства: ')
        device_numbers = input('Введите количество новых устройств: ')
        ...
        return f'Устройство {device} добавлено на склад {self.store}'
